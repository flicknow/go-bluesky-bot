module github.com/flicknow/go-bluesky-bot

go 1.23

require (
	github.com/bluesky-social/indigo v0.0.0-20241004003547-5668e31f6c8e
	github.com/ericvolp12/jetstream v0.0.0-20240919233908-7c5bcf4bddf2
